...
from bot import Bot
from config import ADMINS, FORCE_MSG, START_MSG, CUSTOM_CAPTION, DISABLE_CHANNEL_BUTTON, PROTECT_CONTENT, LOG_CHANNEL, IS_VERIFY
from helper_func import subscribed, encode, decode, get_messages
from verify import check_token, get_token, verify_user, check_verification, get_shortlink
from database.database import add_user, del_user, full_userbase, present_user

SECONDS = int(os.getenv("SECONDS", "10")) #add time im seconds for waitingwaiting before delete

# Other variables
SECONDS = 10  # You can change the value as per your requirement
